...
function Footer() {
  return (
    <footer className="bg-gradient-to-b from-lavender-50 to-white">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex space-x-3">
              <a
                ...
                className="w-10 h-10 rounded-full bg-gradient-to-br from-lavender-400 to-blush-400 flex items-center justify-center text-white hover:shadow-lg hover:scale-110 transition-all duration-200"
            ...
            <ul className="space-y-2">
              {quickLinks.map((link) => (
                <li key={link.path}>
                  <Link
                    to={link.path}
                    className="text-gray-600 hover:text-lavender-600 transition-colors text-sm"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                ...
                >
                  <Phone size={16} className="text-lavender-500" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-2 sm:space-y-0">
            <p className="text-gray-500 text-sm text-center sm:text-left">
              © {new Date().getFullYear()} Slayed and Nailed by YeYa. All rights reserved.
            </p>
            <div className="flex space-x-4 text-sm">
              <Link to="/contact" className="text-gray-500 hover:text-lavender-600 transition-colors">
                Contact
              </Link>
              <Link to="/booking" className="text-gray-500 hover:text-lavender-600 transition-colors">
                Book Now
              </Link>
            </div>
          </div>
