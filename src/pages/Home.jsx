    ...
    <div className="pt-16 md:pt-20">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-white/95 via-lavender-50/90 to-blush-50/90"></div>
        </div>
        <div className="absolute top-20 left-10 w-32 h-32 bg-blush-200/40 rounded-full blur-3xl"></div>
        <div className="absolute bottom-20 right-10 w-40 h-40 bg-lavender-200/40 rounded-full blur-3xl"></div>

        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          <div className="space-y-6 md:space-y-8">
            <div className="inline-flex items-center space-x-2 px-4 py-2 bg-white/80 backdrop-blur rounded-full shadow-sm">
              <Sparkles className="w-4 h-4 text-gold-500" />
              <span className="text-sm font-medium text-gray-700">Luxury Nail Salon in Saint Lucia</span>
            </div>

            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-playfair font-bold leading-tight">
              <span className="text-gray-800">Slayed & Nailed</span>
              <br />
              <span className="gradient-text">by YeYa</span>
            </h1>
            ...
            <div className="flex items-center justify-center space-x-1">
              ...
              <span className="ml-2 text-sm text-gray-600">200+ Happy Clients</span>
            </div>

            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
              <Link to="/booking" className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-lavender-500 to-blush-500 text-white rounded-full font-semibold text-lg shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300">
                Book Your Appointment
              </Link>
              <Link to="/services" className="w-full sm:w-auto px-8 py-4 bg-white text-gray-800 rounded-full font-semibold text-lg shadow-md hover:shadow-lg hover:bg-lavender-50 transition-all duration-300 border border-gray-200">
                View Services
              </Link>
            </div>
          </div>
      ...
      {/* Featured Services */}
      <section className="py-16 md:py-24 bg-gradient-to-b from-white to-lavender-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16">
            <span className="inline-block px-4 py-1.5 bg-lavender-100 text-lavender-700 rounded-full text-sm font-medium mb-4">Our Services</span>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-playfair font-bold text-gray-800 mb-4">Premium Nail Services</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">Discover our range of luxury nail treatments</p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            {services.map((service) => (
              <Link key={service.id} to={`/services#${service.id}`} className="group relative bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300">
          ...
          <div className="text-center mt-12">
            <Link to="/services" className="inline-flex items-center space-x-2 px-6 py-3 bg-white text-lavender-600 rounded-full font-medium shadow-md hover:shadow-lg hover:bg-lavender-50 transition-all duration-200 border border-lavender-200">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="relative order-2 lg:order-1">
              ...
              <div className="absolute -bottom-6 -right-6 md:bottom-8 md:right-8 bg-white rounded-2xl shadow-xl p-6 max-w-xs">
                <div className="flex items-center space-x-4 mb-3">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-lavender-400 to-blush-400 flex items-center justify-center">
            ...
            <div className="order-1 lg:order-2">
              <span className="inline-block px-4 py-1.5 bg-blush-100 text-blush-700 rounded-full text-sm font-medium mb-4">About Us</span>
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-playfair font-bold text-gray-800 mb-6">
                Where Artistry Meets<br /><span className="gradient-text">Luxury</span>
              </h2>
              ...
              <div className="space-y-4 mb-8">
                {[
                  ...
                  <div key={index} className="flex items-start space-x-4">
                    <div className="flex-shrink-0 w-10 h-10 rounded-lg bg-lavender-100 flex items-center justify-center">
              ...
              <Link to="/about" className="inline-flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-lavender-500 to-blush-500 text-white rounded-full font-medium shadow-md hover:shadow-lg hover:scale-105 transition-all duration-200">
      ...
      {/* Gallery Preview */}
      <section className="py-16 md:py-24 bg-gradient-to-b from-lavender-50 to-blush-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16">
            <span className="inline-block px-4 py-1.5 bg-white text-lavender-700 rounded-full text-sm font-medium mb-4">Our Work</span>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-playfair font-bold text-gray-800 mb-4">Nail Gallery</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">Browse our portfolio of stunning nail designs</p>
          </div>
          ...
          <div className="text-center mt-12">
            <Link to="/gallery" className="inline-flex items-center space-x-2 px-6 py-3 bg-white text-lavender-600 rounded-full font-medium shadow-md hover:shadow-lg hover:bg-lavender-50 transition-all duration-200 border border-lavender-200">
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16">
            <span className="inline-block px-4 py-1.5 bg-blush-100 text-blush-700 rounded-full text-sm font-medium mb-4">Testimonials</span>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-playfair font-bold text-gray-800 mb-4">What Our Clients Say</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">Real reviews from happy clients</p>
          </div>

          <div className="grid md:grid-cols-3 gap-6 md:gap-8">
            {reviews.map((review, index) => (
              <div key={index} className="relative bg-gradient-to-br from-lavender-50 to-blush-50 rounded-2xl p-6 md:p-8 shadow-md hover:shadow-xl transition-shadow duration-300">
      ...
      <section className="py-16 md:py-24 bg-gradient-to-b from-white to-lavender-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              <span className="inline-block px-4 py-1.5 bg-gold-100 text-gold-700 rounded-full text-sm font-medium mb-4">Pricing</span>
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-playfair font-bold text-gray-800 mb-6">
                Luxury Services at<br /><span className="gradient-text">Fair Prices</span>
              </h2>
              ...
              <div className="space-y-4">
                {pricingItems.map((item, index) => (
                  <div key={index} className="flex items-center justify-between p-4 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <span className="text-lavender-600 font-semibold">{item.price}</span>
                  </div>
                ))}
              </div>

              <Link to="/pricing" className="inline-flex items-center space-x-2 mt-8 px-6 py-3 bg-white text-lavender-600 rounded-full font-medium shadow-md hover:shadow-lg hover:bg-lavender-50 transition-all duration-200 border border-lavender-200">
      ...
      <section className="py-16 md:py-24 bg-lavender-50">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <span className="inline-block px-4 py-1.5 bg-white text-lavender-700 rounded-full text-sm font-medium mb-4">FAQ</span>
            <h2 className="text-3xl md:text-4xl font-playfair font-bold text-gray-800 mb-4">Frequently Asked Questions</h2>
            <p className="text-gray-600">Got questions? We have answers!</p>
          </div>

          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <details key={index} className="bg-white rounded-xl shadow-sm overflow-hidden group open:shadow-md">
                <summary className="px-6 py-5 cursor-pointer list-none font-semibold text-gray-800 flex justify-between items-center hover:bg-lavender-50 transition-colors">
                  <span>{faq.question}</span>
                  <ChevronDown className="w-5 h-5 text-lavender-600 transition-transform group-open:rotate-180" />
                </summary>
      ...
      {/* Booking CTA */}
      <section className="py-16 md:py-24 bg-gradient-to-br from-lavender-500 via-blush-500 to-gold-400 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <div className="inline-flex items-center space-x-2 px-4 py-2 bg-white/20 backdrop-blur rounded-full mb-6">
            ...
            <span className="text-white text-sm font-medium">Ready to Get Slayed?</span>
          </div>

          <h2 className="text-3xl md:text-4xl lg:text-5xl font-playfair font-bold text-white mb-6">Book Your Appointment Today</h2>
          <p className="text-lg text-white/90 mb-10 max-w-2xl mx-auto">
            Transform your nails into stunning works of art. Our expert team is ready to pamper you.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/booking" className="w-full sm:w-auto px-8 py-4 bg-white text-lavender-600 rounded-full font-semibold text-lg shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 flex items-center justify-center space-x-2">
              <Clock className="w-5 h-5" />
              <span>Book Online Now</span>
            </Link>
            <a href="tel:+17587270420" className="w-full sm:w-auto px-8 py-4 bg-white/20 backdrop-blur text-white rounded-full font-semibold text-lg hover:bg-white/30 transition-all duration-200 flex items-center justify-center space-x-2 border border-white/30">
              <span>Call Us</span>
            </a>
          </div>

          <p className="mt-8 text-white/80 text-sm">Open Monday - Saturday, 9:00 AM - 6:00 PM</p>
        </div>
      </section>
    </div>
  )
